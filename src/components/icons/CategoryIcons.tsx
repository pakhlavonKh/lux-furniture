...
//   <svg viewBox="0 0 96 72" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="miter" className={className}>
...
//     <line x1="12" y1={BASELINE_Y} x2="84" y2={BASELINE_Y} />
//   </svg>
// );

// export const KitchenIcon = ({ className }: IconProps) => (
//   <svg viewBox="0 0 96 72" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="miter" className={className}>
...
//     <line x1="8" y1={BASELINE_Y} x2="88" y2={BASELINE_Y} />
//   </svg>
// );

// export const GardenIcon = ({ className }: IconProps) => (
//   <svg viewBox="0 0 96 72" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
//     <line x1="18" y1={BASELINE_Y} x2="78" y2={BASELINE_Y} />
//   </svg>
// );
...
//     <ellipse cx="48" cy="58" rx="6" ry="2" />
//     <line x1="10" y1={BASELINE_Y} x2="86" y2={BASELINE_Y} />
//   </svg>
// );

// export const ChildrenIcon = ({ className }: IconProps) => (
//   <svg viewBox="0 0 96 72" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
//     <line x1="14" y1={BASELINE_Y} x2="86" y2={BASELINE_Y} />
//   </svg>
// );
...
//     <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
//   </svg>
// );
...
export const StorageIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <rect x="20" y="12" width="56" height="44" />
    <line x1="48" y1="12" x2="48" y2="56" />
...
export const KitchenIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <rect x="18" y="12" width="60" height="14" />
    <line x1="48" y1="26" x2="48" y2="34" />
    <rect x="14" y="40" width="68" height="16" />
    <rect x="42" y="42" width="12" height="12" />
    <line x1="20" y1="48" x2="36" y2="48" />
    <line x1="60" y1="48" x2="76" y2="48" />
    <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
  </svg>
);
...
export const GardenIcon = ({ className }: IconProps) => (
  ...
  >
    {/* Umbrella */}
    <path d="M28 30 Q48 14 68 30 Z" />
    <line x1="48" y1="30" x2="48" y2="44" />

    {/* Table */}
    <ellipse cx="48" cy="46" rx="18" ry="6" />
    <line x1="48" y1="52" x2="48" y2="58" />

    {/* Left chair */}
    <rect x="26" y="44" width="8" height="8" rx="1" />
    <line x1="26" y1="52" x2="24" y2="58" />
    <line x1="34" y1="52" x2="36" y2="58" />

    {/* Right chair */}
    <rect x="62" y="44" width="8" height="8" rx="1" />
    <line x1="62" y1="52" x2="60" y2="58" />
    <line x1="70" y1="52" x2="72" y2="58" />
...
export const OfficeIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <rect x="30" y="12" width="36" height="20" />
    <line x1="48" y1="32" x2="48" y2="40" />
    <rect x="18" y="40" width="60" height="6" />
    <line x1="26" y1="46" x2="26" y2="56" />
    <line x1="70" y1="46" x2="70" y2="56" />
    <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
  </svg>
);
...
export const ChildrenIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <rect x="28" y="34" width="40" height="14" />
    <circle cx="38" cy="32" r="4" />
    <circle cx="58" cy="32" r="4" />
    <line x1="28" y1="48" x2="24" y2="56" />
    <line x1="68" y1="48" x2="72" y2="56" />
    <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
  </svg>
);
...
export const IndustrialIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <rect x="22" y="24" width="52" height="20" />
    <line x1="58" y1="16" x2="58" y2="24" />
    <line x1="66" y1="18" x2="66" y2="24" />
    <rect x="28" y="44" width="40" height="6" />
    <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
  </svg>
);
...
export const AccessoriesIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M36 18 L60 18 L54 30 L42 30 Z" />
    <line x1="48" y1="30" x2="48" y2="46" />
    <ellipse cx="48" cy="48" rx="8" ry="3" />
    <line x1="14" y1={BASELINE_Y} x2="82" y2={BASELINE_Y} />
  </svg>
);