...
const seedContent = async () => {
  try {
    ...
    const discounts = [
      {
        title: {
          en: "Premium Office Desk Sale",
          ru: "Распродажа премиум офисного стола",
          uz: "Premium ofis stolining sotuvlari",
        },
        description: {
          en: "15% discount on selected premium office desks and cabinets.",
          ru: "Скидка 15% на избранные премиум офисные столы и шкафы.",
          uz: "Tanlangan premium ofis stolov va shkaflari bo'yicha 15% chegirma.",
        },
        percentage: 15,
        productIds: ["1", "2"],
        isActive: true,
      ...
      {
        title: {
          en: "Luxury Cabinet Collection - 20% Off",
          ru: "Коллекция люкс-шкафов - скидка 20%",
          uz: "Lux kabinet kolleksiyasi - 20% chegirma",
        },
        description: {
          en: "Experience elegance with 20% off our premium filing cabinets and storage solutions.",
          ru: "Испытайте элегантность со скидкой 20% на наши премиум шкафы для документов и решения хранения.",
          uz: "20% chegirma bilan bizning premium fayl kabineti va saqlash yechimlarini sinovdan o'tkazing.",
        },
        percentage: 20,
        productIds: ["3", "4"],
        isActive: true,
      ...
      {
        title: {
          en: "Lighting Fixture Special",
          ru: "Специальное предложение светильников",
          uz: "Yoritgich maxsus taklifi",
        },
        description: {
          en: "Brighten your space with 25% off selected lighting fixtures and decorative pieces.",
          ru: "Осветите свое пространство 25% скидкой на избранные световые приборы и декоративные предметы.",
          uz: "25% chegirma bilan o'z bo'shliqni yoritingiz va dekorativ narsalarni tanlang.",
        },
        percentage: 25,
        productIds: ["5"],
        isActive: true,
      ...
      {
        title: {
          en: "Seasonal Collection Flash Sale",
          ru: "Распродажа сезонной коллекции",
          uz: "Mavsumiy kolleksiya uchun tez sotuvlar",
        },
        description: {
          en: "Limited time: 18% discount on artVision collection items.",
          ru: "Ограниченное время: 18% скидка на предметы коллекции artVision.",
          uz: "Vaqt cheklangan: artVision kolleksiya narsalari bo'yicha 18% chegirma.",
        },
        percentage: 18,
      ...
      {
        title: {
          en: "Designer Selection - Premium Pieces",
          ru: "Выбор дизайнера - премиум предметы",
          uz: "Dizayner tanlovi - premium narsalar",
        },
        description: {
          en: "Curated discount of 12% on our favorite handpicked designer items.",
          ru: "Курируемая скидка 12% на наши любимые предметы, выбранные дизайнером.",
          uz: "Bizning sevimli dizayner tomonidan tanlangan narsalar bo'yicha 12% chegirma.",
        },
        percentage: 12,
        productIds: ["4", "5"],
        isActive: true,
      ...
      {
        title: {
          en: "Spring Refresh Discount",
          ru: "Скидка на весеннее обновление",
          uz: "Bahor yangilash chegirmasi",
        },
        description: {
          en: "Get your space ready for spring with 16% off storage and organization solutions.",
          ru: "Подготовьте свое пространство к весне со скидкой 16% на решения для хранения и организации.",
          uz: "16% chegirma bilan o'z bo'shliqni bahorga tayyorlang saqlash va tashkilot yechimlarida.",
        },
        percentage: 16,
        productIds: ["1", "2", "3"],
        isActive: true,
